...
output_folder = r"C:\Users\Salin\OneDrive\Documentos\ESSEX\DSPROJECT\PPG_HR_Preprocessed_Splitted_Videos\PPG_HR_Preprocessed_3_sec"
...
for filename in os.listdir(input_folder):
    if filename.endswith(".csv"):
       ...
       # Replacing invalid values (-1) with NaN to flag them for imputation
        ...
        df['SourceStimuliName'] = df['SourceStimuliName'].replace(fixing_names)
        ...
        split_intervals = {
            "HP_1-1": {"original_interval": (26, 32), "merge_intervals": [(8, 11), (22, 26)], "new_video_name": "HP_1-2"},
            "HP_3-1": {"original_interval": (0, 33), "merge_intervals": [(33, 35)], "new_video_name": "HP_3-2"},
            "HP_7-1": {"original_interval": (6, 8), "merge_intervals": [(0, 6)], "new_video_name": "HP_7-2"},
            "HN_2-1": {"original_interval": (10, 24), "merge_intervals": [(0, 10)], "new_video_name": "HN_2-2"},
            "HN_3-1": {"original_interval": (42, 47), "merge_intervals": [(0, 13)], "new_video_name": "HN_3-2"},
            "LN_7-1": {"original_interval": (60, 81), "merge_intervals": [(0, 13)], "new_video_name": "LN_7-2"},
        }
